Option Explicit On
Module Channel_Square_2


    Public Function Square_Channel_2_Render_Sample() As Long
        With Square_Channel_2
            If .Length_Counter > 0 Then
                ...
                If .WaveStatus Then
                    Square_Channel_2_Render_Sample = 0
                    Exit Function
                End If

                If Not .Envelope_Decay_Disable Then
                    Square_Channel_2_Render_Sample = &H40 * .Envelope
                    Exit Function
                End If

                Square_Channel_2_Render_Sample = &H40 * .Volume
                Exit Function
            Else
                '.SampleCount = 0
            End If
                ...
                If .Wavelength >= 8 Then
                    ...
                    Else
                        If .Sweep_Enabled And .Sweep_Right_Shift <> 0 And .Length_Counter > 0 Then  'If all 3 conditions are met, update the wavelength register
                            ...
                            Square_Channel_2_Update_Frequency()
                        End If
                    End If
                End If
            End If
    ...
    Public Sub Square_Channel_2_Update_Envelope()
        With Square_Channel_2
    ...
    Public Sub Square_Channel_2_Decrement_Length_Counter()
        With Square_Channel_2
    ...
    Public Sub Square_Channel_2_Write_Register_1(ByVal Value As Byte)
        '$4004
        '          Bits: 7654 3210
    ...
    Public Sub Square_Channel_2_Write_Register_2(ByVal Value As Byte)
        '$4005
    ...
    Public Sub Square_Channel_2_Write_Register_3(ByVal Value As Byte)
        '$4006
    ...
    Public Sub Square_Channel_2_Write_Register_4(ByVal Value As Byte)
        '$4007
